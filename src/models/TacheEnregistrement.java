...
public class TacheEnregistrement extends TacheVol {
	...
	private static Hashtable<String, TacheEnregistrement> lesTachesEnregistrement = new Hashtable<String, TacheEnregistrement>();
	...
	public static Hashtable<String, TacheEnregistrement> getLesTachesEnregistrement() {
